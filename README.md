...
rapid antigen test and PCR data*. The code was written and executed by me.
The data were collected under the supervision of and provided by J. Horn and J. Seybold (Charité Berlin). The raw data are not 
