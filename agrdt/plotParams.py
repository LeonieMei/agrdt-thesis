...
_PARAM_NAME_MAPPINGS = {
    ...
    "variant[1]": ALPHA_LABEL,
    "variant[2]": DELTA_LABEL,
    "variant[3]": OMICRON_LABEL,
    "VariantCode[1]": DELTA_LABEL,
    "VariantCode[2]": OMICRON_BA1_LABEL,
    "VariantCode[3]": OMICRON_BA2_LABEL,
    ...
    "days4Variant[0]": "1-7 d.p.o. | Pre-VOC",
    ...
    "days4Symptoms3[1]": "1-7 d.p.o. | symptoms",
...
_PARAM_NAME_MAPPINGS_TABLE_LATEX = {
    ...
    "binDaysPostOnset[1]": "2-7 d.p.o.",
    "binDaysPostOnsetReverse[1]": "0-2 d.p.o.",
    "binDaysPostOnset4[1]": "1-7 d.p.o.",
    "binDaysPostOnsetReverse4[1]": "0-1 d.p.o.",
    "daysVariant[0]": "2-7 d.p.o. | Pre-VOC",
    "daysVariant[1]": "2-7 d.p.o. | Alpha",
    "daysVariant[2]": "2-7 d.p.o. | Delta",
    "daysVariant[3]": "2-7 d.p.o. | Omicron",
