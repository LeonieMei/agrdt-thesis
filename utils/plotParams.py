...
_PARAM_NAME_MAPPINGS = {
    ...
    "variant[1]": f"{_LABELS['variant']}: {ALPHA_LABEL} - " f"{WT_LABEL}",
    "variant[2]": f"{DELTA_LABEL} - {WT_LABEL}",
    "variant[3]": f"{OMICRON_LABEL} - {WT_LABEL}",
    "VariantCode[1]": f"{DELTA_LABEL} - {WT_LABEL}",
    "VariantCode[2]": f"{OMICRON_BA1_LABEL} - {WT_LABEL}",
    "VariantCode[3]": f"{OMICRON_BA2_LABEL} - {WT_LABEL}",
    "binDaysPostOnsetReverse[1]": "0-2 d.p.o.- 2-7 d.p.o.",
    "binDaysPostOnset[1]": "2-7 d.p.o.- 0-2 d.p.o.",
    "daysVariant[0]": ("2-7 d.p.o.- 0-2 d.p.o. | Pre-VOC"),
    "daysVariant[1]": ("2-7 d.p.o.- 0-2 d.p.o. | Alpha"),
    "daysVariant[2]": ("2-7 d.p.o.- 0-2 d.p.o. | Delta"),
    "daysVariant[3]": ("2-7 d.p.o.- 0-2 d.p.o. | Omicron"),
    "daysReverseVariant[0]": "0-2 d.p.o.- 2-7 d.p.o. | Pre-VOC",
    "daysReverseVariant[1]": ("0-2 d.p.o. - 2-7 d.p.o. | Alpha"),
    "daysReverseVariant[2]": ("0-2 d.p.o.- 2-7 d.p.o. | Delta"),
    "daysReverseVariant[3]": ("0-2 d.p.o.- 2-7 d.p.o. | Omicron"),
    "days4Variant[0]": (f"1-7 d.p.o.- 0-1 d.p.o. | Pre-VOC"),
    "days4Variant[1]": ("1-7 d.p.o.- 0-1 d.p.o. | Alpha"),
    "days4Variant[2]": ("1-7 d.p.o.- 0-1 d.p.o. | Delta"),
    "days4Variant[3]": ("1-7 d.p.o. - 0-1 d.p.o. | Omicron"),
    "days4ReverseVariant[0]": "0-1 d.p.o.- 1-7 d.p.o. | Pre-VOC",
    "days4ReverseVariant[1]": ("0-1 d.p.o.- 1-7 d.p.o. | Alpha"),
    "days4ReverseVariant[2]": ("0-1 d.p.o.- 1-7 d.p.o. | Delta"),
    "days4ReverseVariant[3]": ("0-1 d.p.o.- 1-7 d.p.o. | Omicron"),
    "days4Symptoms3[1]": (f"1-7 d.p.o.- 0-1 d.p.o. | symptoms"),
    "days4Symptoms3[2]": ("1-7 d.p.o.- 0-1 d.p.o. | URT symptoms"),
    "days4ReverseSymptoms3[1]": "0-1 d.p.o.- 1-7 d.p.o. | symptoms",
    "days4ReverseSymptoms3[2]": ("0-1 d.p.o.- 1-7 d.p.o. | URT symptoms"),
    "daysImmun2YN[0]": "2-7 d.p.o.- 0-2 d.p.o. | not immunized",
    "daysImmun2YN[1]": ("2-7 d.p.o.- 0-2 d.p.o. | multiply immunized"),
    "days4Immun2YN[0]": "1-7 d.p.o.- 0-1 d.p.o. | not immunized",
    "days4Immun2YN[1]": ("1-7 d.p.o.- 0-1 d.p.o. | multiply immunized"),
    ...
    "roche_abbott_variant[0]": "Roche - Abbott | pre-VOC",
    "roche_abbott_variant[1]": "Roche - Abbott | Omicron",
    "zVlImmun2YN[0]": (_LABELS["vl"] + " | not immunized"),
    ...
    "variantSymptoms[0]": f"{_LABELS['variant']}: {ALPHA_LABEL} - "
    f"{WT_LABEL} | "
    f"asymptomatic",
    "variantSymptoms[1]": f"{DELTA_LABEL} - {WT_LABEL} | asymptomatic",
    "variantSymptoms[2]": f"{OMICRON_LABEL} - {WT_LABEL} | asymptomatic",
    "variantSymptoms[3]": f"{ALPHA_LABEL} - {WT_LABEL} | symptomatic",
    "variantSymptoms[4]": f"{DELTA_LABEL} - {WT_LABEL} | symptomatic",
    "variantSymptoms[5]": f"{OMICRON_LABEL} - {WT_LABEL} | symptomatic",
...
_PARAM_NAME_MAPPINGS_TABLE_LATEX = {
    ...
    "variant[1]": f"{ALPHA_LABEL} - {WT_LABEL}",
    "variant[2]": f"{DELTA_LABEL} - {WT_LABEL}",
    "variant[3]": f"{OMICRON_LABEL} - {WT_LABEL}",
    "VariantCode[1]": f"{DELTA_LABEL} - {WT_LABEL}",
    "VariantCode[2]": f"{OMICRON_BA1_LABEL} - {WT_LABEL}",
    ...
    "roche_abbott_variant[0]": "Roche - Abbott | pre-VOC",
    "roche_abbott_variant[1]": "Roche - Abbott | Omicron",
    "binDaysPostOnset[1]": (f"2-7 d.p.o.- 0-2 d.p.o."),
    "binDaysPostOnsetReverse[1]": (f"0-2 d.p.o.- 2-7 d.p.o."),
    "binDaysPostOnset4[1]": (f"1-7 d.p.o.- 0-1 d.p.o."),
    "binDaysPostOnsetReverse4[1]": (f"0-1 d.p.o.- 1-7 d.p.o."),
    "daysVariant[0]": (f"2-7 d.p.o.- 0-2 d.p.o. | Pre-VOC"),
    "daysVariant[1]": ("2-7 d.p.o.- 0-2 d.p.o. | Alpha"),
    "daysVariant[2]": ("2-7 d.p.o.- 0-2 d.p.o. | Delta"),
    "daysVariant[3]": ("2-7 d.p.o. - 0-2 d.p.o. | Omicron"),
    "daysReverseVariant[0]": f"0-2 d.p.o.- 2-7 d.p.o| Pre-VOC",
    "daysReverseVariant[1]": ("0-2 d.p.o.- 2-7 d.p.o. | Alpha"),
    "daysReverseVariant[2]": ("0-2 d.p.o.- 2-7 d.p.o. | Delta"),
    "daysReverseVariant[3]": ("0-2 d.p.o.- 2-7 d.p.o. | Omicron"),
    "days4Variant[0]": (f"1-7 d.p.o.- 0-1 d.p.o. | Pre-VOC"),
    ...
    "zVlImmun2YN[0]": (_LABELS_LATEX["vl"] + " | not immunized"),
    ...
    "symptoms3Reverse[2]": "no symptoms",
    "illSeverityURT": "severity of URT symptoms",
    "variantSymptoms[0]": f"{ALPHA_LABEL} - {WT_LABEL} | asymptomatic",
    "variantSymptoms[1]": f"{DELTA_LABEL} - {WT_LABEL} | asymptomatic",
    "variantSymptoms[2]": f"{OMICRON_LABEL} - {WT_LABEL} | asymptomatic",
    "variantSymptoms[3]": f"{ALPHA_LABEL} - {WT_LABEL} | symptomatic",
    "variantSymptoms[4]": f"{DELTA_LABEL} - {WT_LABEL} | symptomatic",
